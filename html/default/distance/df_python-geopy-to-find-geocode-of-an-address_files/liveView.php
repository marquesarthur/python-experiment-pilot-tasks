...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=105845&cbuster=[CACHE_BUSTER]&pubUrl=https%3A%2F%2Fwww.askpython.com%2Fpython%2Fpython-geopy-to-find-geocode-of-an-address&subId=[SUBID_ENCODED]&x=[WIDTH]&y=[HEIGHT]&schain=1.0,1!adpushup.com,88a32a9bb8bd00f53f184a87de57393f,1&cbuster=1642097997',
					origQString: 's=105845&cbuster=[CACHE_BUSTER]&pubUrl=https%3A%2F%2Fwww.askpython.com%2Fpython%2Fpython-geopy-to-find-geocode-of-an-address&subId=[SUBID_ENCODED]&x=[WIDTH]&y=[HEIGHT]&schain=1.0,1!adpushup.com,88a32a9bb8bd00f53f184a87de57393f,1',
					placementId: 105845,
					x: 640,
					y: 440,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Ubuntu","osVersion":"","osVersionMajor":"0","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Firefox","browserType":"browser","browserVersion":"95.0","browserVersionMajor":"95","browserVersionMinor":"0","chromeVersion":""},"browser":"firefox","os":"linux","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 1,
					geo: 'CA',
					dmaCode: 0,
					dynamicSetup: [],
